...
@Component({
  ...
  template: `
    <section class="page">
      <div class="wrap">
        <app-section-label index="05" label="service" />

        <header class="hero">
          <h1 class="title font-display" reveal="up" [revealDelay]="80">
            <span class="title__primary">In the</span>
            <span class="title__accent">Corps.</span>
          </h1>

          <div class="hero__meta font-mono" reveal="up" [revealDelay]="200">
            <span class="dot"></span>
          ...
          <p class="intro text-pretty" reveal="up" [revealDelay]="280">
            {{ data.summary }}
          </p>
        </header>
        ...
        <section class="row row--three">
          <!-- RANK -->
          <article class="card card--rank" reveal="up" [revealDelay]="120">
          ...
          <article class="card card--qual" reveal="up" [revealDelay]="220">
          ...
          <!-- BFT -->
          <article class="card card--bft" reveal="up" [revealDelay]="320">
        ...
        <!-- PILLARS -->
        <section class="pillars" reveal="up">
          <div class="pillars__label font-mono">// values carried forward</div>
          <div class="pillars__grid">
            @for (p of data.pillars; track p.word; let i = $index) {
            <div class="pillar" reveal="up" [revealDelay]="i * 70">
              <div class="pillar__word font-display">{{ p.word }}</div>
        ...
        <section class="courses">
          <div class="courses__head" reveal="up">
            <h2 class="courses__h font-display">
              Courses &amp; <span class="ital">qualifications.</span>
            </h2>
          ...
          <div class="course-grid">
            ...
            <article class="course" reveal="up" [revealDelay]="i * 80">
              ...
              <div class="course__body">
                ...
                @if (c.detail) {
                <p class="course__detail">{{ c.detail }}</p>
                }
              </div>
            </article>
            }
        ...
        <!-- CLOSING -->
        <section class="closing" reveal="up">
          <blockquote class="closing__q font-display">
            “Discipline is doing it cold,
            <span class="ital">tired, and right.”</span>
          </blockquote>
  ...
  styles: [
    `
      ...
      .title__accent {
        ...
        font-style: italic;
        font-weight: 300;
        background-image: linear-gradient(90deg, #d23045 0%, #f59e0b 55%, #fde68a 100%);
        -webkit-background-clip: text;
        background-clip: text;
        -webkit-text-fill-color: transparent;
        color: transparent;
        filter: drop-shadow(0 0 36px rgba(245, 158, 11, 0.35))
      ...
      .hero__meta .sep { color: rgba(255, 255, 255, 0.25); }
      .intro {
        margin-top: 1.5rem;
        max-width: 42rem;
        font-size: 1.05rem;
      ...
      .bft-bar__fill {
        height: 100%;
        background: linear-gradient(90deg, #d23045, #f59e0b, #fbbf24);
        border-radius: 9999px;
        width: 0;
        animation: bftFill 1.6s cubic-bezier(0.16, 1, 0.3, 1) 0.5s both;
      ...
      @media (min-width: 700px) {
        .pillars__grid { grid-template-columns: repeat(2, 1fr); gap: 1.25rem; }
      }
      ...
      .courses__h .ital {
        font-style: italic;
        font-weight: 300;
        background-image: linear-gradient(90deg, #d23045, #f59e0b);
        -webkit-background-clip: text;
        background-clip: text;
        -webkit-text-fill-color: transparent;
        color: transparent;
      ...
      .closing__q .ital {
        font-style: italic;
        font-weight: 300;
        background-image: linear-gradient(90deg, #f59e0b, #fb7185);
        -webkit-background-clip: text;
        background-clip: text;
        -webkit-text-fill-color: transparent;
        color: transparent;
